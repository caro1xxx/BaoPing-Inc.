  ...
  <div class="home">
    ...
    <el-table :data="prizeData" class="home_table">
      ...
      <el-table-column prop="create_time" label="申请时间">
        <template #default="scope">
          <span>{{ parseStampTime(scope.row.create_time) }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="status" label="状态" />
      <el-table-column label="操作">
        <template #default="scope">
          <svg @click="deletePrize(scope.row, scope.$index)" t="1677475434506" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6493" id="mx_n_1677475434509" width="20" height="20">
