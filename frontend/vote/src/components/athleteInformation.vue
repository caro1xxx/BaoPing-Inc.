    ...
    <div class="body">
        <div class="body_content">
            <div class="body_content_brief">
                <div class="body_content_brief_item">
                    <img v-if="athleteInformation.avator" :src="`${HOST2}/media/${athleteInformation.avator}`" alt="">
                </div>
                <div class="body_content_brief_item">
                    <div class="body_content_brief_number">编号：{{ props.data }}</div>
                    <div class="body_content_brief_name">{{ athleteInformation.name }}</div>
                </div>
            </div>
            <div class="body_content_separate"></div>
            <div class="body_content_ranking">
                <div class="body_content_ranking_item" style="font-size: 20px;font-weight: bold;">当前票数</div>
                <div class="body_content_ranking_item" style="font-size: 20px;font-weight: bold;">当前排名</div>
                <div class="body_content_ranking_item" style="font-size: 17px;color: #33CC66;">{{ athleteInformation.count }}</div>
                <div class="body_content_ranking_item" style="font-size: 17px;color: #33CC66;">{{ props.data }}</div>
            </div>
            <div class="body_content_sign">
                <img style="width: 30px;height: 30px;margin-right: 10px;" src="" alt="">
        ...
        <div class="footer">
            <div class="footer_item1">
                <button style="background-color: #ffffff;color:rgb(36, 105, 77);" @click="returnPage(false)">首页</button>
            </div>
            <div class="footer_item2">
                <button style="background-color: orange;color: #ffffff;" @click="like">投一票</button>
            </div>
            <div class="footer_item1">
                <button style="background-color:rgb(36, 105, 77);color: #ffffff;">助力</button>
            </div>  
        </div>
    </div>
</template>
