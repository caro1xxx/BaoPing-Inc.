"""
Django settings for vote_redirect project.
...
SECRET_KEY = 'django-insecure-v&h(n+zfy@8to5ackpf)pq0=w3!qjhp*pxjde$-tc5n_@p5&qs'
...
ROOT_URLCONF = 'vote_redirect.urls'
...
WSGI_APPLICATION = 'vote_redirect.wsgi.application'
